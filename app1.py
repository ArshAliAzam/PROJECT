...
st.markdown("""
    <style>
    .stApp {
        background-image: url("https://i.pinimg.com/736x/8c/7a/05/8c7a05d38cb7213b00c01b64a16d35df.jpg");
...
st.markdown("<h1 style='color: white;'>🔐Password strength checker</h1>", unsafe_allow_html=True)
